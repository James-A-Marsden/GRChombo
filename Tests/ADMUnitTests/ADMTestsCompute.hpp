...
template <class deriv_t> class ADMTestsCompute
{
  ...
  public:
    ...
    // template <class data_t> struct Vars// using Vars =
    // ADMFixedBGVars::Vars<data_t>;
    ...
    template <class data_t> struct Vars
    {
        ...
        void enum_mapping(mapping_function_t mapping_function)
        {
            ...
            // GRInterval<c_gamma_UU11,c_gamma_UU33>(), gamma_UU);
            // define_enum_mapping(mapping_function, c_gamma_UU11,
            // gamma_UU[0][0]); define_enum_mapping(mapping_function,
            // c_gamma_UU11, gamma_UU[0][0]);
            // define_enum_mapping(mapping_function, c_d1_gamma_UU111,
            // gamma_UU[0][0]);
            define_symmetric_enum_mapping(
                mapping_function,
                GRInterval<c_d1_gamma_UU11, c_d1_gamma_UU33>(), gamma_UU);
            define_symmetric_enum_mapping(
                mapping_function, GRInterval<c_d2_gamma11, c_d2_gamma33>(),
                gamma);
            define_symmetric_enum_mapping(
                mapping_function,
                GRInterval<c_d1_K_tensor11, c_d1_K_tensor33>(), K_tensor);
            ...
            */
            ...
            define_enum_mapping(mapping_function,
                                GRInterval<c_d2_shift1, c_d2_shift3>(), shift);
        }
    };
