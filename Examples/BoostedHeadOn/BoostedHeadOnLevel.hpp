...
#ifndef BOOSTEDHEADONLEVEL_HPP_
#define BOOSTEDHEADONLEVEL_HPP_
...
class BoostedHeadOnLevel : public GRAMRLevel
{
    friend class DefaultLevelFactory<BoostedHeadOnLevel>;
