    ...
    template <class data_t> void compute(Cell<data_t> current_cell) const
    {
        ...
        */
        ...
        vars.fbar[0] = metric_vars.K_tensor[1][2] * metric_vars.K_tensor[1][2] * d1.fhat[0] - metric_vars.K_tensor[1][1] * metric_vars.K_tensor[2][2] * d1.fhat[0]
                      -metric_vars.K_tensor[0][2] * metric_vars.K_tensor[1][2] * d1.fhat[1] + metric_vars.K_tensor[0][1] * metric_vars.K_tensor[2][2] * d1.fhat[1]
        ...
        */
        ...
        FOR2(i,j)
        {
          vars.w += gamma_UU[i][j] * d1.fbar[i][j];//ADD DERIVATIVE OF fbar
          FOR1(k)
          {
