                ...
                FOR1(l)
                {
                    primaryScalar +=
                        ...
                        (metric_vars.ricci_phys[i][j] * vars.fspatial[k][l] +
                         metric_vars.d1_lapse[k] * d1.fspatial[i][l][j] /
                             metric_vars.lapse -
                         metric_vars.d1_lapse[k] * metric_vars.d1_lapse[l] *
                             vars.fspatial[i][j] / metric_vars.lapse /
                             metric_vars.lapse +
                         metric_vars.d2_lapse[k][l] * vars.fspatial[i][j] /
                             metric_vars.lapse);
                    FOR1(m)
                    {
                        primaryScalar +=
                            ...
                            (metric_vars.d1_lapse[k] *
                                 (chris_phys.ULL[m][i][j] *
                                  ...
                                  chris_phys.ULL[m][l][j] *
                                      vars.fspatial[i][m]) /
                                 metric_vars.lapse +
                             vars.fspatial[i][j] * chris_phys.ULL[m][l][k] *
                                 metric_vars.d1_lapse[m] / metric_vars.lapse);
                    }
                }
            }
        }
