...
#SBATCH -J l_run #Give it something meaningful.
...
#SBATCH --mail-type=NONE # ALL/BEGIN/END/FAIL/NONE
...
mpirun -np $SLURM_NTASKS ../mass_decoupled_5.ex mass_decoupled_5.txt
