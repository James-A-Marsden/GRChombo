...
class TensorFieldTaggingCriterion
{
  ...
  public:
    TensorFieldTaggingCriterion(const double dx, const int a_level,
        ...
        : m_dx(dx), m_L(a_L), m_level(a_level), m_center(a_center), m_deriv(dx){};
    ...
    template <class data_t> void compute(Cell<data_t> current_cell) const
    {
        ...
        */
        ...
        /*   
        FOR(idir) m_deriv.diff1(d1_fspatial33, current_cell, idir, c_fspatial33);   
        FOR(idir) m_deriv.diff1(d1_fspatial12, current_cell, idir, c_fspatial12);   
        FOR(idir) m_deriv.diff1(d1_fspatial13, current_cell, idir, c_fspatial13);   
        FOR(idir) m_deriv.diff1(d1_fspatial23, current_cell, idir, c_fspatial23);  
        */
        ...
        */
        ...
        FOR(idir)
        {
          ...
          mod_d1_v += d1_v11[idir] * d1_v11[idir] + d1_v22[idir] * d1_v22[idir];// + d1_v33[idir] * d1_v33[idir]
